...
<head>
    ...
    <title>Dashboard - WhyNot Admin Organisasi</title>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ route('admin.jenisaktivitas') }}">WhyNot</a>
                        </div>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item  ">
                                    <a href="{{ route('admin.jenisaktivitas')}}" class="submenu-link">Kelola Jenis Aktivitas</a>

                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ route('admin.listaktivitas')}}" class="submenu-link">List Aktivitas</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item  ">
                                    <a href="{{ route('admin.relawan')}}" class="submenu-link">Kelola Relawan</a>

                                </li>
                                <li class="submenu-item  ">
                                    <a href="{{ route('admin.organisasi')}}" class="submenu-link">Kelola Organisasi</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item">
                                    <a href="#" class="submenu-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Keluar</a>
