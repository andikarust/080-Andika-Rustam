...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item">
                <a href={{ route('admin.acara') }} class='sidebar-link'>
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="{{ route('admin.profile') }}" class="submenu-link">Profile</a>
                        
                    </li>
                    
                    <li class="submenu-item  ">
                        <a href="logout.html" class="submenu-link">Log Out</a>
