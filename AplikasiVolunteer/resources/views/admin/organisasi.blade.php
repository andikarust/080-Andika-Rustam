                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    {{-- <div class="edit">
                                        <button type="button" class="btn btn-primary d-flex justify-content-end bg-warning"
                                    ...
                                    <div class="hapus">
                                        <button type="button" class="btn btn-primary d-flex justify-content-end bg-danger"
